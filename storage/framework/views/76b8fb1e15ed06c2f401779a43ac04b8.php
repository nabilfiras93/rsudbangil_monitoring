            ...
            <div class="row justify-content-center">
                <div class="col-md-3 col-lg-3 col-xl-3 border-danger">
                    <div class="card pricing-box ribbon-box right border card-border-danger">
                        <div class="card-body p-4">
                            ...
                            <a href="<?php echo e(url('dashboard/bed')); ?>">
                                <div class="p-4">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 border-danger">
                    <div class="card pricing-box ribbon-box right border card-border-danger">
                        <div class="card-body p-4">
                            <!-- <div class="ribbon-two ribbon-two-danger"><span>Popular</span></div> -->
                            <a href="<?php echo e(url('dashboard/radiology')); ?>">
                                <div class="p-4">
                ...
                <div class="col-md-3 col-lg-3 col-xl-3 border-danger">
                    <div class="card pricing-box ribbon-box right border card-border-danger">
                        <div class="card-body p-4">
                            <!-- <div class="ribbon-two ribbon-two-danger"><span>Popular</span></div> -->
                            <a href="<?php echo e(url('dashboard/lab')); ?>">
                                <div class="p-4">
                                    <img src="<?php echo e(asset('images/icon/double-bed.png')); ?>" class="img-fluid mx-auto" />
                                </div>
                                <div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp82\htdocs\rsud-dev\resources\views/portal.blade.php ENDPATH**/ ?>