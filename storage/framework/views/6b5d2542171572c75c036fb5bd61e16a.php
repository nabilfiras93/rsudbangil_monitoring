    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body collapse show" id="collapseAnggrek">
                    <div class="card">
                        <div class="row">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="d-flex">
                                            <div class="flex-grow-1 text-muted overflow-hidden">
                                                <button type="button" class="mb-2 btn btn-danger  text-dark fw-bold">
                                                Bed 1
                                                </button>
                                                <button type="button" class="mb-2 btn btn-success text-dark fw-bold">
                                                Bed 2
                                                </button>
                                                <button type="button" class="mb-2 btn btn-success  text-dark fw-bold">
                                                Bed 3
                                            ...
                                            <div class="flex-shrink-0 ms-2">
                                                <div class="badge bg-info-subtle text-dark fs-15">
                                                    Kamar 1</div>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layouts-horizontal-only-topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp82\htdocs\rsud-dev\resources\views/bed/list.blade.php ENDPATH**/ ?>