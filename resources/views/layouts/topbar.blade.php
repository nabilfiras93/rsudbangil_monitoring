            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="{{ URL::asset('images/rsud.png') }}" alt="" height="60">
                        </span>
                        <span class="logo-lg">
                            <img src="{{ URL::asset('images/rsud.png') }}" alt="" height="50">
                        </span>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">@if(Auth::user()){{ Auth::user()->name }} @else Display @endif</span>
                            </span>
                        </span>
                    </button>
                    
                    @if(session()->isStarted() && session('role')!='guest')
